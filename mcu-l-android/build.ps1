...
& $Aapt2 link -o $UnsignedApk --manifest (Join-Path $ProjectRoot 'AndroidManifest.xml') -I $AndroidJar -A $AssetRoot --min-sdk-version 24 --target-sdk-version 35 --version-code 9 --version-name '0.6.2' $CompiledResources
...
$FinalApk = Join-Path $DistRoot 'MCUS-0.6.2-debug.apk'
